...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2026 at 08:42 PM
...
(29, 13, 'Introduction to Computing 1', 'ITC1', 'Ms. Estillore', 21, '10:00:00', '11:00:00', 'Room 4', '2026-05-21 13:11:01'),
(31, 6, 'Sample Subject 1', 'SS1', 'Jino Estillore', 22, '07:00:00', '08:00:00', 'Room 5', '2026-05-24 09:23:31'),
(32, 7, 'Sample Subject 2', 'SS2', 'Jino Estillore', 19, '09:00:00', '11:09:00', 'Room 6', '2026-05-24 09:24:04'),
(33, 7, 'Sample Subject 3', 'SS3', 'Jino Estillore', 10, '08:00:00', '09:00:00', 'Room 1', '2026-05-24 09:30:47'),
(34, 14, 'Sample Subject 1', 'SS1', 'Jino Estillore', 12, '08:00:00', '09:00:00', 'Room 1', '2026-05-24 16:23:52'),
(35, 9, 'Sample Subject 1', 'SS1', 'Jino Estillore', 21, '10:00:00', '11:00:00', 'Room 2', '2026-05-24 18:12:30'),
(36, 15, 'Sample Subject 1', 'SS1', 'Jino Estillore', 21, '11:00:00', '12:00:00', 'Room 1', '2026-05-24 18:32:05'),
(37, 16, 'Sample Subject 1', 'SS1', 'Jino Estillore', 23, '02:33:00', '03:33:00', 'Room 1', '2026-05-24 18:33:06');
...
INSERT INTO `study_plans` (`id`, `user_id`, `subject_id`, `topic_id`, `study_date`, `start_time`, `end_time`, `status`, `notes`, `created_at`) VALUES
(3, 8, 29, 22, '2026-05-25', '16:12:00', '17:12:00', 'Completed', 'Just a testing', '2026-05-24 08:13:00'),
(5, 1, 21, 2, '2026-05-26', '11:00:00', '12:00:00', 'Pending', 'Testing', '2026-05-24 08:24:49'),
(6, 1, 21, 2, '2026-05-25', '11:00:00', '12:00:00', 'Pending', 'Testing', '2026-05-24 08:30:13'),
(7, 1, 21, 2, '2026-05-19', '11:00:00', '12:00:00', 'Completed', 'Testubg', '2026-05-24 08:30:54'),
(8, 1, 8, 4, '2026-05-26', '10:00:00', '11:00:00', 'Pending', 'Test', '2026-05-24 08:41:43'),
(9, 8, 29, 22, '2026-05-24', '08:00:00', '09:00:00', 'Completed', 'Test', '2026-05-24 09:20:38'),
(10, 1, 22, 21, '2026-05-25', '15:00:00', '16:00:00', 'Pending', 'Testing', '2026-05-24 09:43:29'),
(11, 16, 34, 23, '2026-05-25', '10:00:00', '11:00:00', 'Pending', 'Testing', '2026-05-24 16:26:15'),
(16, 5, 35, 24, '2026-05-24', '01:00:00', '02:00:00', 'Completed', 'ASd', '2026-05-24 18:27:11'),
(19, 15, 25, 11, '2026-05-24', '01:00:00', '02:00:00', 'Completed', '', '2026-05-24 18:30:12'),
(20, 6, 37, 25, '2026-05-24', '02:33:00', '03:33:00', 'Completed', 'asd', '2026-05-24 18:33:31');
...
(19, 22, 'Sample Title of Note', 'A sample content of this Sample Title of Note', '2026-05-20 05:47:12'),
(20, 34, 'Sample Note', 'Testing', '2026-05-24 16:24:21');
...
(8, 21, 'Sample Task', 'Sample description of this task', '2026-05-20', 'Completed', '2026-05-18 19:46:42'),
...
(11, 25, 'Test', 'testss', '2026-05-21', 'Completed', '2026-05-19 14:51:23'),
(12, 25, 'asdasd', 'asd', '2026-05-22', 'Completed', '2026-05-19 14:53:52'),
(14, 22, 'A Sample Title of a Task', 'This is a sample description of this A Sample Title of a Task', '2026-05-22', 'Pending', '2026-05-20 06:06:36'),
(15, 34, 'Sample Task', 'Testing', '2026-05-27', 'Pending', '2026-05-24 16:24:39'),
(16, 29, 'Sample', 'SampleeeeSampleeeeSampleeeeSampleeee', '2026-05-25', 'Completed', '2026-05-24 17:43:05'),
(17, 35, 'Sasdas', 'WAdasdasa', '2026-05-26', 'Completed', '2026-05-24 18:12:44'),
(18, 35, 'Test', 'Asdasda', '2026-05-27', 'Completed', '2026-05-24 18:16:41'),
(19, 35, 'Asd', 'asdasd', '2026-05-25', 'Completed', '2026-05-24 18:25:39'),
(20, 35, 'aDsad', 'asdasd', '2026-05-25', 'Completed', '2026-05-24 18:26:08'),
(21, 29, 'Asd', 'asd', '2026-05-25', 'Completed', '2026-05-24 18:30:45'),
(22, 36, 'Asd', 'asd', '2026-05-25', 'Completed', '2026-05-24 18:32:13');
...
(3, 21, 'OOP', 'Upcoming', '2026-05-18 19:45:40', 'A programming paradigm fundamental to many programming languages, including Java and C++. In this article, we\'ll provide an overview of the basic concepts of OOP.', 'Not Started'),
(4, 8, 'Web Designs', 'Upcoming', '2026-05-19 07:59:57', 'HTML Web Design Structure for UI', 'Studying'),
...
(6, 8, 'Sample Topic', 'Upcoming', '2026-05-19 08:50:43', 'A sample topic description for testing purposes only', 'Not Started'),
...
(11, 25, 'HTML Designs', 'Upcoming', '2026-05-19 14:15:39', 'A sample description of this topic HTML Designs', 'Studying'),
(21, 22, 'Sample Topic Name 101', 'Upcoming', '2026-05-20 06:09:06', 'This is a sample description of Sample Topic Name 101', 'Not Started'),
(22, 29, 'Computing', 'Upcoming', '2026-05-21 13:12:08', 'A sample description of Computing in ITC1.', 'Studying'),
(23, 34, 'MYSQL', 'Upcoming', '2026-05-24 16:24:51', 'Testing', 'Studying'),
(24, 35, 'HTML Designs', 'Upcoming', '2026-05-24 18:13:19', 'ASd', 'Studying'),
(25, 37, 'MYSQL', 'Upcoming', '2026-05-24 18:33:17', 'ASdasdas', 'Studying');
...
(8, 21, 'jino-estillore-ai-certificate.pdf', 'uploads/topic_files/topic_6a0d57c32846c7.89610821.pdf', '2026-05-20 06:42:11'),
(9, 22, 'jino-estillore-ai-certificate.pdf', 'uploads/topic_files/topic_6a12c21955def1.40834272.pdf', '2026-05-24 09:17:13'),
(10, 22, 'Scope-and-Limitation.docx', 'uploads/topic_files/topic_6a12c227764305.04869773.docx', '2026-05-24 09:17:27'),
(11, 22, 'certificate-Aica-Vonicca-Daño.pdf', 'uploads/topic_files/topic_6a12c231bb4b11.68984226.pdf', '2026-05-24 09:17:37'),
(12, 22, 'capstone-project-consent.docx', 'uploads/topic_files/topic_6a12c23af1e702.68003448.docx', '2026-05-24 09:17:46'),
(13, 23, 'profile.jpg', 'uploads/topic_files/topic_6a13266b6a40a5.89809532.jpg', '2026-05-24 16:25:15');
...
(11, 21, '1. This part is a highlight', '2026-05-20 06:26:44'),
(12, 22, 'Test 1', '2026-05-24 09:16:54'),
(13, 22, 'Test 2', '2026-05-24 09:16:57'),
(14, 22, 'Test 3', '2026-05-24 09:17:01'),
(15, 23, '1. Testing', '2026-05-24 16:25:06');
...
(8, 21, 'What is HTML?', 'HTML (HyperText Markup Language) is the standard language used to create and structure content on the web. It is considered the \"skeleton\" or building block of every website you visit.', '2026-05-20 06:42:53'),
(9, 22, 'What HTML stands for?', 'Hypertext Mark-up Language', '2026-05-24 09:08:18'),
(10, 22, 'What is Javascript?', 'A high-level, dynamic programming language used primarily to create interactive and complex features on websites', '2026-05-24 09:18:14'),
(11, 22, 'What is OOP?', 'Object-Oriented Programming (OOP) in Java is a programming paradigm that organizes software design around objects rather than functions or logic', '2026-05-24 09:18:45'),
(12, 22, 'What is the name of our planet?', 'Earth', '2026-05-24 09:19:05'),
(13, 23, 'What is the name of our planet?', 'Earth', '2026-05-24 16:25:30');
...
INSERT INTO `users` (`id`, `fullname`, `email`, `password`, `created_at`, `profile_picture`, `security_question`, `security_answer`, `current_streak`, `longest_streak`, `last_study_date`) VALUES
(1, 'Jino Estillore', 'jinoestillore@email.com', '$2y$10$EoDMrQFAzfJSzo5VKUin1evXF9qbwl3UCw.BFqi64vmgL9djRpS2S', '2026-05-06 16:39:09', '1779459041_6a1063e10004f.jpg', 'What city were you born in?', '$2y$10$RfB0zrSKC2Uf1Zm90jk1benSPyH8njbfBjNcWwKVzOeZf5FOBpZKm', 8, 9, '2026-05-24'),
(2, 'Jino Student', 'jinostudent@email.com', '$2y$10$7cyArqkdZOa7/4wVt0nOwOhY2Ih4kdiDuznKdWZHY0.QFMQan9hg.', '2026-05-06 17:48:38', NULL, NULL, NULL, 1, 1, '2026-05-25'),
(3, 'Student One', 'jino1@email.com', '$2y$10$hqNG90caB/0J9NiMK80WM.Gtq5cNO1FaH43bgjOCXlaBOX0.z0kMe', '2026-05-09 16:35:27', NULL, NULL, NULL, 0, 0, NULL),
(5, 'Jin Estillore', 'jinoes@email.com', '$2y$10$54QHpBbrMj2COBodBD/aA.KUkLquR16o.6WnGdwH11W1WFPhCQEji', '2026-05-18 13:56:06', NULL, NULL, NULL, 0, 0, '2026-05-25'),
(6, 'Student Two', 'studenttwo@email.com', '$2y$10$ZRIqfvudakjNzxEjW7eWd.CWx.nCKjmJef6f2.y/WpzAa02A8vDOC', '2026-05-19 13:42:42', NULL, NULL, NULL, 1, 1, '2026-05-25'),
(8, 'John Cena', 'jino2@email.com', '$2y$10$XQtH1MdT.3WEQXagkkrBBu2sNJVw8XDzfKe6aOOdTW.4nhrRXgxmi', '2026-05-19 13:47:46', '1779372776_6a0f12e816b42.jpg', NULL, NULL, 2, 2, '2026-05-25'),
(15, 'Jin Mori', 'jin@email.com', '$2y$10$.vCHXqYcZPNgddKF190VKe/CmYOonxtdPbOhHm9NpLLG4AQ.lyPry', '2026-05-19 14:03:20', NULL, NULL, NULL, 0, 0, '2026-05-25'),
(16, 'Student One', 'so@email.com', '$2y$10$vVOXOZGIS0sGMjZySXW.4O3R7pqrt0wqEuTQW/H.lplDWB9XsUX8u', '2026-05-24 16:22:55', NULL, NULL, NULL, 0, 0, NULL);
